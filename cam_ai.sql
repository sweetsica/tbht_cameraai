...
-- Dumping data for table cam_ai.belong: ~1 rows (approximately)
REPLACE INTO `belong` (`id`, `id_staff`, `id_room`) VALUES
	(32, '1', 37);
...
REPLACE INTO `company` (`id`, `name_company`, `level`) VALUES
	(41, 'Thái Hưng', 0),
...
-- Dumping data for table cam_ai.room: ~1 rows (approximately)
REPLACE INTO `room` (`id`, `name_room`, `id_company`, `level`) VALUES
	(37, 'IT', 41, 1);
...
REPLACE INTO `timekeeping` (`id`, `date`, `time_now`, `time_out`, `role`, `id_belong`) VALUES
...
-- Dumping data for table cam_ai.user: ~9 rows (approximately)
REPLACE INTO `user` (`id`, `fullname`, `email`, `date_birth`, `date_job_receive`, `status`, `role`) VALUES
