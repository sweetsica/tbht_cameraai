var Dial = function(container1) {
    ...
    this.size = this.container1.dataset.size;
    this.strokeWidth = this.size / 8;
    this.radius = (this.size / 2) - (this.strokeWidth / 2);
    this.value = this.container1.dataset.value;
    this.direction = this.container1.dataset.arrow;
    this.svg;
    this.defs;
    this.slice;
    this.overlay;
...
Dial.prototype.create = function() {
    ...
    this.createText();
    this.createArrow();
    this.container1.appendChild(this.svg);
};
