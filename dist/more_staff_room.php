...
include 'config/function.php';?>
                ...
                <div class="container-fluid page__container">
                        ...
                        <form action="api/them/more_belong.php" method="POST" enctype="multipart/form-data" >
                        <div class="row">
                            <div class="col-lg-9 pr-lg-0">
                                ...
                                <div class="page-section">
                                    ...
                                    <div class="page-nav__content">
                                            ...
                                            href="api/thuoc/update_hanet.php">Cập Nhật Nhân Viên Thuộc Phòng từ Hanet</a>
                                        </div>
                                    <!-- 361-371 -->
                                    <form action="api/thuoc/create.php" method="POST" enctype="multipart/form-data">
