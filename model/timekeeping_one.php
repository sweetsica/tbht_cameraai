...
class data_day_one{
                        ...
                        public function bang(){
                            ...
                            if($x['data']==null){
                                echo "<tr>
                                <th class='pr-0' colspan='7'>
                                <div class='d-flex align-items-center' x;>
                                               <span class='js-lists-values-employer-name text-70'>
                                               <p style='font-size:20px;color:red;'>Hiện hôm nay không có nhân viên vào đi làm</p></span>
                                        </div>
                                <th></tr>";
