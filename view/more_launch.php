...
include '../config/function.php';?>
                ...
                <div class="container-fluid page__container">
                        ...
                        <form action="../api/more/more_launch.php" method="POST" enctype="multipart/form-data" >
                        <div class="row">
                            <div class="col-lg-9 pr-lg-0">
                                ...
                                <div class="page-section">
                                    ...
                                    <div  class="page-nav__content">
                                        ...
                                        style="margin-left: 80%; margin-top: -85px;" href="../api/company/update_hanet.php">Cập Nhật Ban từ Hanet</a>
                                    </div>
                                    <!-- 361-371 -->
