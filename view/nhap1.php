        ...
        <div class="table-responsive"
            ...
            <table class="table table-bordered table-flush mb-0 thead-border-top-0 table-nowrap">
                                ...
                                <tbody class="list" id="contacts">
                                    ...
                                    "SELECT DISTINCT n.fullname FROM timekeeping AS l
                                    ...
                                    for($i=1;$i<$Month;$i++){ 
                                        ...
                                        $sql_string="SELECT l.date,l.time_now,l.time_out,l.id_belong,n.fullname,p.name_room,l.role FROM timekeeping AS l
                                        left JOIN belong AS t ON t.id=l.id_belong
                                        LEFT JOIN room AS p ON p.id=t.id_room
                                        LEFT JOIN user AS n ON n.id=t.id_staff
                                        where n.fullname='".$hien['fullname']."' AND l.date='".$datedaysql."'";
                                        
                                        
                                        // if(mysqli_query($conn,$sql_string)>0){
                                        //         // echo'
                                        //         // <td>
